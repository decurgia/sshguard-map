...
blacklist_cursor.execute('''CREATE TABLE IF NOT EXISTS Blacklist
...
blacklist_cursor.execute('''CREATE TRIGGER IF NOT EXISTS blacklist_record_inserted
...
blacklist_cursor.execute('''CREATE TRIGGER IF NOT EXISTS blacklist_record_updated
...
for entry in blacklist_file:
    ...
    blacklist_cursor.execute('''INSERT OR IGNORE INTO Blacklist (ip_address)
                                                    VALUES (?)''',
                             (ip_address, ))
